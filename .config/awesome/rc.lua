...
-- Other built-in themes: default, sky, xresources, and zenburn
...
-- for xmodmap, switching caps_lock for esc and vicesversa
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    -- Old config: awful.screen.focused().mypromptbox:run()
    awful.key({ modkey },"r", function() awful.util.spawn("rofi -modi drun -show drun -show-icons -width 22",false) end,
